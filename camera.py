...
class VeinCamera:
    def __init__(self, resolution=(640, 480), framerate=30, simulation_mode=None):
        ...
        # Available resolutions with appropriate framerates (using 4:3)
        self.available_resolutions = {
            "480p": {"resolution": (640, 480), "framerate": 30},
             "768p": {"resolution": (1024, 768), "framerate": 30}, # Added 1024x768
             "1232p": {"resolution": (1640, 1232), "framerate": 20}, # Half sensor resolution
            # "720p": {"resolution": (1280, 720), "framerate": 30}, # Removed 16:9
            # "1080p": {"resolution": (1920, 1080), "framerate": 25}, # Removed 16:9
        }
